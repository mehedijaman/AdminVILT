        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4 gap-2">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AdminVILT</span>
                </a>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <button type="button"
                    ...
                    <img v-if="$page.props.jetstream.managesProfilePhotos" class="h-8 w-8 rounded-full"
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    ...
                    <div class="py-3 px-4">
                        ...
                        <span class="block text-sm text-gray-900 truncate dark:text-white">{{ $page.props.auth.user.email
                        }}</span>
                    </div>
